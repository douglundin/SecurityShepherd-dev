		...
		if (Validate.validateAdminSession(ses, tokenCookie, tokenParmeter)) {
			...
			if (Validate.validateTokens(tokenCookie, tokenParmeter)) {
				...
				try {
					...
					if (classId.isEmpty()) // Null Submitted - configure scoreboard to list all players regardless of
											// class
					{
					...
					out.print("<h3 class=\"title\">Scoreboard Configuration Failure</h3><br>" + "<p>"
			...
			out.print("<h3 class=\"title\">Failure</h3><br>" + "<p>"
					+ "<font color=\"red\">An error Occurred! Please try non administrator functions!</font>" + "<p>");
		}
